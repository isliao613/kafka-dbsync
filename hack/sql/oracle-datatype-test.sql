...
CREATE TABLE DEMO.DATATYPE_TEST (
    ...
    -- Boolean (Oracle 23c+, simulated with NUMBER for XE 21c)
...
INSERT INTO DEMO.DATATYPE_TEST (
    ID,
    COL_NUMBER, COL_NUMBER_5, COL_NUMBER_10, COL_NUMBER_19, COL_NUMBER_38,
    ...
    'CHAR10', 'Character data with padding', 'VARCHAR2 short', 'VARCHAR2 medium length text for testing', 'VARCHAR2 longer text content here for comprehensive testing of character handling',
    N'NCHAR', N'Unicode text: 日本語テスト',
    ...
    'This is a CLOB test content with more text for testing large character objects.',
    N'This is NCLOB with Unicode: 中文測試 한국어',
    UTL_RAW.CAST_TO_RAW('Binary BLOB data'),
    UTL_RAW.CAST_TO_RAW('Raw binary'),
    1
);

-- Insert test data row 2 - edge case values
INSERT INTO DEMO.DATATYPE_TEST (
    ID,
    COL_NUMBER, COL_NUMBER_5, COL_NUMBER_10, COL_NUMBER_19, COL_NUMBER_38,
    COL_NUMBER_10_2, COL_NUMBER_15_5, COL_FLOAT, COL_BINARY_FLOAT, COL_BINARY_DOUBLE,
    ...
    'NEG', 'Negative test values', 'Negative', 'Edge case negative numbers', 'Testing negative number handling across Debezium versions',
    N'NEG', N'Negative: マイナス値',
    ...
    'CLOB with negative test case',
    N'NCLOB negative: 負のテスト',
...
-- Insert test data row 4 - zero and empty values
INSERT INTO DEMO.DATATYPE_TEST (
    ID,
    COL_NUMBER, COL_NUMBER_5, COL_NUMBER_10, COL_NUMBER_19, COL_NUMBER_38,
    COL_NUMBER_10_2, COL_NUMBER_15_5, COL_FLOAT, COL_BINARY_FLOAT, COL_BINARY_DOUBLE,
